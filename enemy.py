...
class enemy():
    ...
    def attackSlime(self,enemy):
        ...
        if rand < 2:
            self.currentHp = self.maxHp
            print("enemy heal")
            regen_sound = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Slime\regenerate.mp3')
            regen_sound.set_volume(1)
            regen_sound.play()

        elif rand >= 2:
            damaged = self.attackPoint - enemy.defendPoint
            attack = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Slime\attack.mp3')
    ...
    def attackZombie(self,enemy):
        ...
        if rand < 3:
            ...
            attack = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Zombie\attack.mp3')
            attack.set_volume(0.8)
            attack.play()
            if damaged <= 0:
                damaged = 0
    ...
    def attackDragon(self,enemy):
        ...
        damaged = 0
        if rand < 21:
            fire_ball = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Dragon\fire.mp3')
            ...
            iron_skill = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Dragon\skin.mp3')
            ...
            if damaged <= 0:
                damaged = 0
            attack = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Dragon\attack.mp3')
            attack.set_volume(0.8)
            attack.play()
    ...
    def isDead(self):
        ...
        if self.currentHp <= 0 and self.name == "zombie":
            rand = random.randint(1,100)
            if rand < 1:
                regen = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Zombie\revive.mp3')
