...
class player():
    ...
    def attack(self,enemy):
        ...
        attack_sound = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\normal attack.mp3')
        ...
        match skillName:
            case "Double Slash":
                if self.currentMp >= 20:
                    ...
                    if dmg <= 0:
                        dmg = 0
                    double_slash = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\double slash.mp3')
            ...
            case "Headbutt":
                if self.currentMp >= 15:
                    ...
                    if dmg <= 0:
                        dmg = 0
                    headbutt = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\headbutt.mp3')
            ...
            case "Paralyze":
                if self.currentMp >= 5:
                    ...
                    if dmg <= 0:
                        dmg = 0
                    paralyze = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\paralyze.mp3')
            ...
            case "Heal":
                if self.currentMp >= 25:
                    ...
                    if self.currentHp >= self.maxHp:
                        self.currentHp = self.maxHp
                    heal = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\healing.mp3')
                    heal.set_volume(0.5)
                    heal.play()
            ...
            case "Restore mana":
                ...
                if self.currentMp >= self.maxMp:
                    self.currentMp = self.maxMp
                restore_mana = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\restore mana.mp3')
            ...
            case "Roaring":
                if self.currentMp >= 30:
                    ...
                    roar = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\roaring.mp3')
                    roar.set_volume(0.5)
                    roar.play()
            ...
            case "Fire ball":
                if self.currentMp >= 35:
                    ...
                    fire_ball = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\fire ball.mp3')
            ...
            case "Lighting bolt":
                if (self.currentMp >= 25):
                    ...
                    if dmg <= 0:
                        dmg = 0
                    lighting = mixer.Sound(r'C:\Users\mayso\Downloads\CPE327\CPE327ProjectPygame-endamonking-patch-1\sound effect\Knight\lighting.mp3')
